...
export const DeleteContact = (obj) => async (dispatch) => {
  ...
  axios.delete(
    ...
    obj
  ).then((res) => { dispatch({ type: DELETE_USER, payload: obj }); console.log("inside dot then of delete method in action.js"); console.log(res.data); }).catch((err) => console.log(err.message));
};
